...
**Parameter ranges** 
The alpha parameter of a Gamma distribution must be greater than 0, that is (0, $\infty$). Note that due to numerical limitations, the smallest value used by MethEvolSIM is 0.01.
