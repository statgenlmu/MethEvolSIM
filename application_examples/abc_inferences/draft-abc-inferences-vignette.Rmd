...
2. Get the CpG count in islands and non-island regions.

3. Filter CpG count to keep only regions with at least one CpG site and get the CpG position indeces for each region.

1. Save as simulation design the genomic structure for the regions within the selected genomic region, tree(s) -- GIVEN -- and sampled parameter combinations.
