...
As SSEc transition probabilities are dependent on adjacent sites we use Gillespie's $\tau$-leap approximation.
...
Note that due to numerical limitations, the smallest value of both parameters used by MethEvolSIM is 0.01.
